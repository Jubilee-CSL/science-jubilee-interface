...
# Exécutables externes — laissez à None pour auto-détection via PATH.
# Override uniquement si les binaires ne sont pas dans PATH.
...
# Default: <repo_root>/experiment_deck/  (i.e. two levels above this file when
# installed editable — src/jubilee_interface/constants.py → repo_root).
import os as _os
EXPERIMENT_OUTPUT_DIR: str = _os.path.abspath(_os.path.join(
